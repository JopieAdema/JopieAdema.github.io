...
subtitle: Expected-points-optimal score predictions for today, tomorrow and the day after
---
...
{% if wc.matches and wc.matches.size > 0 %}
  ...
  {% endfor %}
{% else %}
  <p class="nomatch">No World Cup matches scheduled in the next three days. Check back later.</p>
{% endif %}
